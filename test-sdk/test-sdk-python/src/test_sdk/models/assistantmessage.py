...
class AssistantMessageTypedDict(TypedDict):
    content: NotRequired[AssistantMessageContentTypedDict]
...
class AssistantMessage(BaseModel):
    content: Optional[AssistantMessageContent] = None

    tool_calls: OptionalNullable[List[ToolCall]] = UNSET

    prefix: Optional[bool] = False

    role: Optional[AssistantMessageRole] = AssistantMessageRole.ASSISTANT
