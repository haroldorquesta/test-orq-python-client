...
from test_sdk.types import OptionalNullable, UNSET
...
class Models(BaseSDK):
    ...
    async def list_models_v1_models_get_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def retrieve_model_v1_models_model_id_get(
        self,
        *,
        model_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def retrieve_model_v1_models_model_id_get_async(
        self,
        *,
        model_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def delete_model_v1_models_model_id_delete(
        self,
        *,
        model_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def delete_model_v1_models_model_id_delete_async(
        self,
        *,
        model_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def jobs_api_routes_fine_tuning_update_fine_tuned_model(
        self,
        *,
        model_id: str,
        update_ft_model_in: Union[
            models.UpdateFTModelIn, models.UpdateFTModelInTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.JobsAPIRoutesFineTuningUpdateFineTunedModelRequest(
            model_id=model_id,
            update_ft_model_in=utils.get_pydantic_model(
    ...
    async def jobs_api_routes_fine_tuning_update_fine_tuned_model_async(
        self,
        *,
        model_id: str,
        update_ft_model_in: Union[
    ...
    def jobs_api_routes_fine_tuning_archive_fine_tuned_model(
        self,
        *,
        model_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def jobs_api_routes_fine_tuning_archive_fine_tuned_model_async(
        self,
        *,
        model_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def jobs_api_routes_fine_tuning_unarchive_fine_tuned_model(
        self,
        *,
        model_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def jobs_api_routes_fine_tuning_unarchive_fine_tuned_model_async(
        self,
        *,
        model_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
